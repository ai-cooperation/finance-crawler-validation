...
- Gate 2 已另以 120 個唯一新聞品牌驗收，116/120 成功（96.67%）。P0 的 soak observation 與七日驗收器已完成本機 TDD，待 migration／Worker 遠端驗證；關閉 P0 仍需配置真人可收取的 primary/fallback、啟用低頻 schedule／Cron，累積七日真實證據。在此之前兩種排程均保持關閉。
