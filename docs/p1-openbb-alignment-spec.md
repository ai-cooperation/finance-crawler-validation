...
- The narrow OIDC route, D1/R2 index/object receipts and `0005_market_alignment.sql` are deployed. Actions run `32333213987` read back `market_20260820t044935z` (3 instruments) and `align_20260820t044935z` (3 topics, coverage `0.333333`); D1 hashes match the R2 objects (`4f74e13db54d97938bbd4cb8d29855c183134ed84c83ef3e97c4839c42442657` and `46f6986501f550fbf98c2fc0206c12dc9faf466982e6acf5f42a9e492e33a081`). Cloudflare reports no unapplied migrations. This unit is **remotely persisted and verified** as the OpenBB-compatible input boundary; the downstream Workers AI report run `32336183763` used this persisted alignment and saved three evidence-linked reports.
