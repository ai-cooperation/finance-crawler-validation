...
- GitHub：`gh api user` 查回 active identity 為 `ai-cooperation`；目前 production source of truth 為 `main`，遠端 commit `8562f310fed801b27dbb27a25fb60b378ad3ddb7`（包含 target-topic gate、admission `httpx` 修正與 workflow 回歸鎖定）。
