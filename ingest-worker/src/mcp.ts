...
const TOOLS = [
  ...
  },
  {
    ...
    description: "Check existing snapshots and return the approved source bundle and refresh decision. Use target.kind (not asset or asset_class) and requirements.question/source_strategy/include_market_data/include_topic_radar/report_profile/max_sources.",
    inputSchema: {
      type: "object",
      additionalProperties: false,
