...
def test_write_depth_artifact_splits_large_depth_from_alignment_envelope(tmp_path: Path, monkeypatch) -> None:
    ...
    assert "evidence_pack" not in alignment["market_snapshot"]["financial_depth"]
    assert "quality_gate" not in alignment["market_snapshot"]["financial_depth"]
    ...
    assert "evidence_pack" not in depth_envelope["financial_depth"]
    assert "quality_gate" not in depth_envelope["financial_depth"]
